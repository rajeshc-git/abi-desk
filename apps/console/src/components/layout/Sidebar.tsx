...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen = false, onClose }) => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      path: '/chat',
      icon: MessageSquare,
      roles: ['TENANT_ADMIN', 'L1_SUPPORT', 'L2_SUPPORT', 'L3_SUPPORT', 'DEV_TEAM', 'DEVOPS_TEAM'],
    ...
    },
    {
      ...
      path: '/analytics',
      icon: BarChart3,
      roles: ['TENANT_ADMIN', 'L1_SUPPORT', 'L2_SUPPORT', 'L3_SUPPORT', 'DEV_TEAM', 'DEVOPS_TEAM', 'QA_TEAM'],
    ...
    },
    {
      ...
      path: '/roster',
      icon: Calendar,
      roles: ['TENANT_ADMIN', 'L1_SUPPORT', 'L2_SUPPORT', 'L3_SUPPORT', 'DEV_TEAM', 'DEVOPS_TEAM', 'QA_TEAM', 'ADMIN', 'PLATFORM_ADMIN'],
    ...
    },
    {
      ...
      roles: ['TENANT_ADMIN', 'L1_SUPPORT', 'L2_SUPPORT', 'L3_SUPPORT', 'DEV_TEAM', 'DEVOPS_TEAM', 'QA_TEAM', 'ADMIN', 'PLATFORM_ADMIN'],
      permissions: ['ticket:read:tenant', 'report:view:tenant', 'admin:brand:manage'],
    },
    {
      title: 'Setup',
      path: '/admin',
