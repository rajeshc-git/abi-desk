...
const TRANSITIONS: TransitionSeed[] = [
  ...
  // ---- Cross-Tier Transfers & Return Paths (Zoho Desk Flexible Flow) ----
  {
    fromStatus: 'ESCALATED_L2',
    toStatus: 'OPEN',
    requiredPermission: 'ticket:update:tenant',
    targetTier: 'L1',
    label: 'Return to L1 Support',
    requiresComment: true,
    sortOrder: 15,
  },
  {
  ...
  },
  {
    ...
    requiredPermission: 'ticket:update:tenant',
    targetTier: 'L1',
    label: 'Return to Support for Client Details',
    requiresComment: true,
    sortOrder: 80,
  },
  {
